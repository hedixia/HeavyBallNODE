...
plt.tight_layout()
plt.savefig('CIFAR_train_loss.pdf')
plt.show()
'''
'''
plt.figure(figsize=(12,12))
...
plt.tight_layout()
plt.savefig('CIFAR_test_loss.pdf')
plt.show()
'''
...
axes.tick_params(axis='x', labelsize=50)
axes.tick_params(axis='y', labelsize=50)
plt.plot(node_test_acc_avg[:plot_len]*100, linewidth=5, color='b', label = "NODE")
plt.plot(anode_test_acc_avg[:plot_len]*100, linewidth=5, color='y', label = "ANODE")
#plt.plot(sonode_test_acc_avg[:plot_len]*100, linewidth=5, color='g', label = "SONODE")
#plt.plot(hbnode_test_acc_avg[:plot_len]*100, linewidth=5, color='r', label = "HBNODE")
plt.plot(hbnode_test_acc_avg[:plot_len]*100, linewidth=5, color='g', label = "SONODE") ##
plt.plot(sonode_test_acc_avg[:plot_len]*100, linewidth=5, color='r', label = "HBNODE") ##
plt.plot(ghbnode_test_acc_avg[:plot_len]*100, linewidth=5, color='m', label = "GHBNODE")
plt.xlabel("Epoch", fontsize=50)
...
plt.tight_layout()
plt.savefig('CIFAR_test_acc.pdf')
plt.show()
...
axes.tick_params(axis='x', labelsize=50)
axes.tick_params(axis='y', labelsize=50)
plt.plot(node_train_fnfe_avg[:plot_len], linewidth=5, color='b', label = "NODE")
plt.plot(anode_train_fnfe_avg[:plot_len], linewidth=5, color='y', label = "ANODE")
plt.plot(sonode_train_fnfe_avg[:plot_len], linewidth=5, color='g', label = "SONODE")
plt.plot(hbnode_train_fnfe_avg[:plot_len], linewidth=5, color='r', label = "HBNODE")
plt.plot(ghbnode_train_fnfe_avg[:plot_len], linewidth=5, color='m', label = "GHBNODE")
plt.xlabel("Epoch", fontsize=50)
...
#plt.legend(loc='bottom left', fontsize=50)
plt.tight_layout()
plt.savefig('CIFAR_forward_nfe.pdf')
plt.show()
...
axes.tick_params(axis='x', labelsize=50)
axes.tick_params(axis='y', labelsize=50)
plt.plot(node_train_bnfe_avg[:plot_len], linewidth=5, color='b', label = "NODE")
plt.plot(anode_train_bnfe_avg[:plot_len], linewidth=5, color='y', label = "ANODE")
plt.plot(sonode_train_bnfe_avg[:plot_len], linewidth=5, color='g', label = "SONODE")
plt.plot(hbnode_train_bnfe_avg[:plot_len], linewidth=5, color='r', label = "HBNODE")
plt.plot(ghbnode_train_bnfe_avg[:plot_len], linewidth=5, color='m', label = "GHBNODE")
plt.xlabel("Epoch", fontsize=50)
...
#plt.legend(loc='bottom left', fontsize=50)
plt.tight_layout()
plt.savefig('CIFAR_backward_nfe.pdf')
plt.show()
'''
plt.figure(figsize=(12,12))
axes = plt.gca()
...
#plt.legend(loc='bottom left', fontsize=50)
plt.tight_layout()
plt.savefig('CIFAR_test_nfe.pdf')
plt.show()
'''
plt.figure(figsize=(12,12))
axes = plt.gca()
...
axes.tick_params(axis='x', labelsize=50)
axes.tick_params(axis='y', labelsize=50)
plt.plot(node_train_cum_time_avg[:plot_len]/1000., linewidth=5, color='b', label = "NODE")
plt.plot(anode_train_cum_time_avg[:plot_len]/1000., linewidth=5, color='y', label = "ANODE")
plt.plot(sonode_train_cum_time_avg[:plot_len]/1000., linewidth=5, color='g', label = "SONODE")
plt.plot(hbnode_train_cum_time_avg[:plot_len]/1000., linewidth=5, color='r', label = "HBNODE")
plt.plot(ghbnode_train_cum_time_avg[:plot_len]/1000., linewidth=5, color='m', label = "GHBNODE")
plt.xlabel("Epoch", fontsize=50)
...
#plt.legend(loc='bottom left', fontsize=50)
plt.tight_layout()
plt.savefig('CIFAR_training_time.pdf')
plt.show()
...
#plt.legend(loc='bottom left', fontsize=50)
plt.tight_layout()
plt.savefig('CIFAR_test_time.pdf')
plt.show()
'''